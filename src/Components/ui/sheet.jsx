...
function SheetHeader({ className, ...props }) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 py-4 border-b border-gray-300", className)}
      {...props}
    />
  )
}
