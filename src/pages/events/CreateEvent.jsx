...
import { createEvent, getAllEventTypes } from '../../utils/authService';
...
export default function CreateEvent() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/events'); // Redirect to an events list page (which doesn't exist yet)
        } catch (error) {
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                <label htmlFor="poster-upload" className="cursor-pointer bg-white rounded-md border border-gray-300 p-2 flex items-center">
                                    ...
                                    <span>{posterFile ? posterFile.name : 'Upload a file'}</span>
                                </label>
                                <Input
                                    id="poster-upload"
                                    type="file"
