        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <div>
            <h2 className="text-2xl font-bold">
              Club Manager&apos;s Dashboard
            </h2>
            <p className="text-gray-500">
              Monitor your club&apos;s activities and requests
            </p>
          </div>
          <div className="flex gap-3">
            <button className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded transition">
              <FaCalendarAlt />
              Book Venue
            </button>
            <button className="flex items-center gap-2 bg-white border px-4 py-2 rounded hover:bg-gray-100 transition">
              <FaFileAlt />
              New Proposal
            </button>
          </div>
