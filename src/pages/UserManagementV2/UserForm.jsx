...
const UserForm = ({ isOpen, onClose, onSubmit, user, roles }) => {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => setFormState(prevState => ({ ...prevState, groups: Array.from(e.target.selectedOptions, option => option.value) }))}
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            >
              {roles.map(role => (
